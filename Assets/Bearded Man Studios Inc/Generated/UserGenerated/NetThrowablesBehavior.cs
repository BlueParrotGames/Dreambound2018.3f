...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class NetThrowablesBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (NetThrowablesNetworkObject)obj;
		...
		{
			Initialize(new NetThrowablesNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new NetThrowablesNetworkObject(networker, this, createCode, metadata);
		}
